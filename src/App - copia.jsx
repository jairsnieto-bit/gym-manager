...
{activeTab === 'inventory-config' && (
  <div className="space-y-6">
    ...
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="flex space-x-4 mb-6">
        <button
          onClick={() => setActiveTab('inventory-categories')}
        ...
        <button
          onClick={() => setActiveTab('inventory-locations')}
          className={`px-4 py-2 rounded-md font-medium ${
        ...
        <button
          onClick={() => setActiveTab('inventory-units')}
          className={`px-4 py-2 rounded-md font-medium ${
  ...
  <div className="space-y-4">
    <div className="flex justify-between items-center">
      ...
      {/* 👇 AÑADE ESTE console.log PARA VERIFICAR QUE LOS DATOS LLEGAN */}
