...
const InventoryConfigTable = ({ 
  ...
  console.log('InventoryConfigTable - items:', items);
  console.log('InventoryConfigTable - configType:', configType);
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {filteredItems.length > 0 ? (
              ...
              <tr>
                <td colSpan={configType === 'unit' ? 4 : 3} className="px-6 py-4 text-center text-sm text-gray-500">
                  No se encontraron {configType === 'category' ? 'categorías' : configType === 'location' ? 'ubicaciones' : 'unidades'}
                </td>
              </tr>
            )}
          </tbody>
